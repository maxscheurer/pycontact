...
def analyze_psf_dcd(psf, dcd, cutoff, hbondcutoff, hbondcutangle, sel1text, sel2text):
                    ...
                    for global_hatom in hydrogenAtomsBoundToAtom1:
                        ...
                        if typeHeavy == AtomHBondType.acc and (distarray[conv_hatom, idx2] <= hbondcutoff):
                            ...
                            if angle >= hbondcutangle:
                                ...
                                new_hbond = HydrogenBond(convindex1, convindex2, global_hatom, dist, angle, hbondcutoff,
                                                         hbondcutangle)
                    ...
                    for global_hatom in hydrogenAtomsBoundToAtom2:
                        ...
                        if typeHeavy == AtomHBondType.acc and (distarray[idx1, conv_hatom] <= hbondcutoff):
                            ...
                            if angle >= hbondcutangle:
                                ...
                                new_hbond = HydrogenBond(convindex2, convindex1, global_hatom, dist, angle, hbondcutoff,
                                                         hbondcutangle)
                                hydrogenBonds.append(new_hbond)
                            # print str(convindex1) + " " + str(convindex2)
...
def analyze_contactResultsWithMaps(contactResults, map1, map2):
    #################################################
