...
#define __PYX_HAVE__gridsearch
#define __PYX_HAVE_API__gridsearch
...
/* Module declarations from 'gridsearch' */
...
#define __Pyx_MODULE_NAME "gridsearch"
int __pyx_module_is_main_gridsearch = 0;
...
static const char __pyx_k_home_max_Projects_pycontact_pyx[] = "/home/max/Projects/pycontact/pyx_src/gridsearch.pyx";
...
static PyObject *__pyx_kp_s_home_max_Projects_pycontact_pyx;
...
/* Python wrapper */
static PyObject *__pyx_pw_10gridsearch_1cy_sasa(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_10gridsearch_1cy_sasa = {"cy_sasa", (PyCFunction)__pyx_pw_10gridsearch_1cy_sasa, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_10gridsearch_1cy_sasa(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_natoms)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("cy_sasa", 1, 11, 11, 1); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_pairdist)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_sasa", 1, 11, 11, 2); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_allow_double_counting)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_sasa", 1, 11, 11, 3); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_maxsize)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_sasa", 1, 11, 11, 4); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_nprad)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_sasa", 1, 11, 11, 5); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_surfacePoints)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_sasa", 1, 11, 11, 6); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_probeRadius)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_sasa", 1, 11, 11, 7); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        case  8:
        if (likely((values[8] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_pointstyle)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_sasa", 1, 11, 11, 8); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        case  9:
        if (likely((values[9] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_restricted)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_sasa", 1, 11, 11, 9); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        case 10:
        if (likely((values[10] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_restrictedList)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_sasa", 1, 11, 11, 10); __PYX_ERR(0, 6, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "cy_sasa") < 0)) __PYX_ERR(0, 6, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("cy_sasa", 1, 11, 11, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 6, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("gridsearch.cy_sasa", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10gridsearch_cy_sasa(__pyx_self, __pyx_v_npcoords, __pyx_v_natoms, __pyx_v_pairdist, __pyx_v_allow_double_counting, __pyx_v_maxsize, __pyx_v_nprad, __pyx_v_surfacePoints, __pyx_v_probeRadius, __pyx_v_pointstyle, __pyx_v_restricted, __pyx_v_restrictedList);
 ...
 *   return sasa
 */
  __pyx_t_2 = __Pyx_PyObject_to_MemoryviewSlice_dc_float(__pyx_v_npcoords);
 ...
 */
  ...
  __pyx_t_4 = -1;
  if (__pyx_t_3 < 0) {
    __pyx_t_3 += __pyx_v_c_coords.shape[0];
    if (unlikely(__pyx_t_3 < 0)) __pyx_t_4 = 0;
  } else if (unlikely(__pyx_t_3 >= __pyx_v_c_coords.shape[0])) __pyx_t_4 = 0;
  if (unlikely(__pyx_t_4 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_4);
    __PYX_ERR(0, 13, __pyx_L1_error)
  }
  __pyx_t_4 = __Pyx_PyInt_As_int(__pyx_v_natoms); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L1_error)
  __pyx_t_5 = __pyx_PyFloat_AsFloat(__pyx_v_pairdist); if (unlikely((__pyx_t_5 == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L1_error)
  __pyx_t_6 = 0;
  __pyx_t_7 = -1;
  if (__pyx_t_6 < 0) {
    __pyx_t_6 += __pyx_v_cy_radius.shape[0];
    if (unlikely(__pyx_t_6 < 0)) __pyx_t_7 = 0;
  } else if (unlikely(__pyx_t_6 >= __pyx_v_cy_radius.shape[0])) __pyx_t_7 = 0;
  if (unlikely(__pyx_t_7 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_7);
    __PYX_ERR(0, 13, __pyx_L1_error)
  }
  __pyx_t_7 = __Pyx_PyInt_As_int(__pyx_v_surfacePoints); if (unlikely((__pyx_t_7 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L1_error)
  __pyx_t_8 = __pyx_PyFloat_AsDouble(__pyx_v_probeRadius); if (unlikely((__pyx_t_8 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L1_error)
  __pyx_t_9 = __Pyx_PyInt_As_int(__pyx_v_pointstyle); if (unlikely((__pyx_t_9 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L1_error)
  __pyx_t_10 = __Pyx_PyInt_As_int(__pyx_v_restricted); if (unlikely((__pyx_t_10 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L1_error)
  __pyx_t_11 = 0;
  __pyx_t_12 = -1;
  if (__pyx_t_11 < 0) {
    __pyx_t_11 += __pyx_v_cy_restrictedList.shape[0];
    if (unlikely(__pyx_t_11 < 0)) __pyx_t_12 = 0;
  } else if (unlikely(__pyx_t_11 >= __pyx_v_cy_restrictedList.shape[0])) __pyx_t_12 = 0;
  if (unlikely(__pyx_t_12 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_12);
    __PYX_ERR(0, 13, __pyx_L1_error)
  }
  __pyx_v_sasa = sasa_grid((&(*((float *) ( /* dim=0 */ ((char *) (((float *) __pyx_v_c_coords.data) + __pyx_t_3)) )))), __pyx_t_4, __pyx_t_5, 0, -1, (&(*((float *) ( /* dim=0 */ ((char *) (((float *) __pyx_v_cy_radius.data) + __pyx_t_6)) )))), __pyx_t_7, __pyx_t_8, __pyx_t_9, __pyx_t_10, (&(*((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_cy_restrictedList.data) + __pyx_t_11)) )))));
 ...
 */
  ...
  __pyx_t_13 = PyFloat_FromDouble(__pyx_v_sasa); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 14, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "gridsearch._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_home_max_Projects_pycontact_pyx, __pyx_k_home_max_Projects_pycontact_pyx, sizeof(__pyx_k_home_max_Projects_pycontact_pyx), 0, 0, 1, 0},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initgridsearch(void); /*proto*/
PyMODINIT_FUNC initgridsearch(void)
#else
PyMODINIT_FUNC PyInit_gridsearch(void); /*proto*/
PyMODINIT_FUNC PyInit_gridsearch(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_gridsearch(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("gridsearch", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_gridsearch) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "gridsearch")) {
      if (unlikely(PyDict_SetItemString(modules, "gridsearch", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *   restricted,restrictedList):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_10gridsearch_1cy_sasa, NULL, __pyx_n_s_gridsearch); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_cy_sasa, __pyx_t_1) < 0) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init gridsearch", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init gridsearch");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
