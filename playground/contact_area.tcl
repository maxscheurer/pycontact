mol new rpn11_ubq_interface-ionized.psf
mol addfile short.dcd waitfor all
set global1 "(protein and segname UBQ)"
set global2 "protein"
set restraints "(segname UBQ and same residue as within 5 of segname RN11)"
